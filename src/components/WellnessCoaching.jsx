    ...
    <>
      ...
      <div className='custom-container px-3 px-lg-5 px-md-5'>
        ...
        <div className="d-flex justify-content-center align-items-center">
          <img src={require('./../assets/mockups/wellness-coaching.png')} className='my-session-img mt-4' alt="" />
        </div>
      </div>
      ...
      <div className='custom-container px-3 px-lg-5 px-md-5'>
        <div className=" mt-3">
          <div className=" text-center group-coaching-session">
            <p >Experience a transformative wellness coaching session where I'll address your negative emotions and help you overcome depression. Embrace a brighter future brimming with endless opportunities and possibilities.</p>
          </div>
        </div>
      </div>
